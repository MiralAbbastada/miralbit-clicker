...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-black flex justify-center">
      ...
      {/* Bottom fixed div */}
      <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-[calc(100%-2rem)] max-w-xl bg-[#272a2f] mb-5 flex justify-around items-center z-50 rounded-3xl text-xs">
